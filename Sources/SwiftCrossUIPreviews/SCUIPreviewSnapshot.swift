    ...
    /// Renders SwiftCrossUI views to images without a running app or a preview
    /// canvas.
    ///
    ...
    /// uses. That makes it usable for documenting a component's appearance and
    /// for catching rendering regressions.
    ///
    /// ```swift
